...
# Set TF_USE_LEGACY_KERAS before importing tensorflow if needed for compatibility
# This needs to be set as an environment variable before the Python interpreter starts,
# or very early in the script. The user has already indicated this is set.
...
try:
    model_path = 'models/model_legacy.h5'
